...
public class HistorialDTO implements Serializable {
    ...
    public HistorialDTO(String id, String pacienteId, String doctorId, LocalDateTime fechaExamen, String diagnostico,
    ...
    public String toString() {
        return "HistorialDTO{" +
                ...
                ", OD[Esf=" + odEsfera + ", Cil=" + odCilindro + ", Eje=" + odEje + "]" +
                ", OI[Esf=" + oiEsfera + ", Cil=" + oiCilindro + ", Eje=" + oiEje + "]" +
                '}';
    }
}